...
@implementation BSSearchResultViewController_iPhone
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray * nib = [[NSBundle mainBundle] loadNibNamed:@"BSSearchResultTableViewCell_iPhone" owner:tableView options:nil];
    BSSearchResultTableViewCell_iPhone *cell = [nib objectAtIndex:0];
